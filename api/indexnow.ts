...
const ALL_URLS = [
  ...
  `https://${SITE}/ru/catalog/supplements`,
  `https://${SITE}/ru/catalog/vitamins`,
  `https://${SITE}/ru/catalog/minerals`,
  `https://${SITE}/ru/catalog/beauty`,
  `https://${SITE}/ru/catalog/herbs`,
  ...
  `https://${SITE}/tr/catalog/supplements`,
  `https://${SITE}/tr/catalog/vitamins`,
  `https://${SITE}/tr/catalog/minerals`,
  `https://${SITE}/tr/catalog/beauty`,
  `https://${SITE}/tr/catalog/herbs`,
  ...
  `https://${SITE}/en/catalog/supplements`,
  `https://${SITE}/en/catalog/vitamins`,
  `https://${SITE}/en/catalog/minerals`,
  `https://${SITE}/en/catalog/beauty`,
  `https://${SITE}/en/catalog/herbs`,
  ...
  `https://${SITE}/ar/catalog/supplements`,
  `https://${SITE}/ar/catalog/vitamins`,
  `https://${SITE}/ar/catalog/minerals`,
  `https://${SITE}/ar/catalog/beauty`,
  `https://${SITE}/ar/catalog/herbs`,
