                ...
                />
                 ...
                 <div className="modal-info-wrapper">
                   <div className="modal-scroll-area">
                    ...
                    <div className="modal-actions-sticky" style={{ paddingTop: '16px', borderTop: '1px solid rgba(0,0,0,0.08)', boxShadow: '0 -4px 12px rgba(0,0,0,0.04)' }}>
                     ...
                     <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                       ...
                       >
                        ...
                        <motion.button 
                          ...
                          style={{ width: '100%', background: 'linear-gradient(135deg, #25D366 0%, #128C7E 100%)', color: 'white', border: 'none', borderRadius: '22px', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', boxShadow: '0 10px 20px rgba(37, 211, 102, 0.15)' }}
                        >
                         {t.cart.buyNow}
                       </motion.button>
                     </div>
