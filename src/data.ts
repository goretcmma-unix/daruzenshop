...
export const products: Product[] = [
  {
    ...
    seoTitle: {
      ru: 'BSO Жевательные мармеладки — Масло чёрного тмина, Витамин D3, Цинк',
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'Омега 3 Премиум — Рыбий жир EPA 600 мг, DHA 400 мг',
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'ACV Мармелад — Яблочный уксус, Витамин B12, Фолиевая кислота',
    ...
    specs: {
      ...
      tr: [
        '| **Etken Madde** | **Porsiyon Miktarı / Serving Size** | **%BRD / DV** |',
        '| ----------------------------- | ----------------------------------: | ------------: |',
        '| Kırmızı Pancar Tozu | 12 mg | %100 |',
        '| Nar Ekstratı | 50 mg | ** |',
        '| Folik Asit (Vitamin B9) | 50 mg | ** |',
        '| Siyanokobalamin (Vitamin B12) | 10 mcg | %100 |',
      ],
      en: [
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'Магний Комплекс + Витамин B6 — 4 формы магния',
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'DNL — Антистресс фитокомплекс — 11 трав для нервной системы',
    ...
    specs: {
      ru: [
        ...
        '| --- | ---: |',
        '| Crataegus sp. (Боярышник) | 172,8 мг |',
        '| Apium graveolens (Сельдерей) | 154,8 мг |',
        '| Uncaria tomentosa (Кошачий коготь) | 118,8 мг |',
        '| Ocimum (Базилик) | 117,94 мг |',
        '| Piper nigrum (Черный перец) | 105,98 мг |',
        '| Rosa sp. (Роза) | 92 мг |',
        '| Hibiscus sabdariffa (Гибискус) | 89,86 мг |',
        '| Lavandula angustifolia (Лаванда) | 75,6 мг |',
        '| Cinnamomum cassia (Корица) | 27,8 мг |',
        '| Elettaria cardamomum (Кардамон) | 26,06 мг |',
        '| Acacia arabica (Акация) | 20,02 мг |',
      ],
      tr: [
        '| **Aktif Bileşen** | **Miktar (2 Tablet)** |',
        '| ----------------------------------- | ----------------: |',
        '| Crataegus sp. (Alıç) | 172,8 mg |',
        '| Apium graveolens (Kereviz) | 154,8 mg |',
        '| Uncaria tomentosa (Kedi Pençesi) | 118,8 mg |',
        '| Ocimum (Fesleğen) | 117,94 mg |',
        '| Piper nigrum (Karabiber) | 105,98 mg |',
        '| Rosa sp. (Gül) | 92 mg |',
        '| Hibiscus sabdariffa (Sudan Bamyası) | 89,86 mg |',
        '| Lavandula angustifolia (Lavanta) | 75,6 mg |',
        '| Cinnamomum cassia (Çin Tarçını) | 27,8 mg |',
        '| Elettaria cardamomum (Kakule) | 26,06 mg |',
        '| Acacia arabica (Arap Zamkı) | 20,02 mg |',
      ],
      en: [
        '| **Active ingredient** | **Composition per 2 tablets** |',
        '| --- | ---: |',
        '| Crataegus sp. (Hawthorn) | 172.8 mg |',
        '| Apium graveolens (Celery) | 154.8 mg |',
        '| Uncaria tomentosa (Cat\'s claw) | 118.8 mg |',
        '| Ocimum (Basil) | 117.94 mg |',
        '| Piper nigrum (Black pepper) | 105.98 mg |',
        '| Rosa sp. (Rose) | 92 mg |',
        '| Hibiscus sabdariffa (Hibiscus) | 89.86 mg |',
        '| Lavandula angustifolia (Lavender) | 75.6 mg |',
        '| Cinnamomum cassia (Cinnamon) | 27.8 mg |',
        '| Elettaria cardamomum (Cardamom) | 26.06 mg |',
        '| Acacia arabica (Acacia) | 20.02 mg |',
      ],
      ar: [
        '| **المكون النشط** | **مكونات قرصين** |',
        '| --- | ---: |',
        '| Crataegus sp. (الزعرور) | 172,8 ملغ |',
        '| Apium graveolens (الكرفس) | 154,8 ملغ |',
        '| Uncaria tomentosa (مخلب القط) | 118,8 ملغ |',
        '| Ocimum (الريحان) | 117,94 ملغ |',
        '| Piper nigrum (الفلفل الأسود) | 105,98 ملغ |',
        '| Rosa sp. (الورد) | 92 ملغ |',
        '| Hibiscus sabdariffa (الكركديه) | 89,86 ملغ |',
        '| Lavandula angustifolia (الخزامى) | 75,6 ملغ |',
        '| Cinnamomum cassia (القرفة) | 27,8 ملغ |',
        '| Elettaria cardamomum (الهيل) | 26,06 ملغ |',
        '| Acacia arabica (الأكاسيا) | 20,02 ملغ |',
      ],
    },
    notes: {
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'Цинк Комплекс — Цинк + Селен + Медь',
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'Enginar — Артишок, Расторопша, Одуванчик для печени',
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'Nadh Gummy — NADH, Глутатион, Коэнзим Q10, Витамин B6, B12',
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'Хром + Гимнема — Витамин для сахара в крови',
    ...
    specs: {
      ...
      tr: [
        '| **Aktif Bileşen** | **Miktar (1 Tablet)** | **% günlük ihtiyaç** |',
        '| --- | ---: | ---: |',
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'Комплекс с гинкго билоба, женьшенем и цитиколином — Витамин для мозга',
    ...
    specs: {
      ...
      tr: ['# 5 ml başına', 'Ginkgo ekstresi | 375 mg', 'Kore ginsengi ekstresi | 20 mg', 'Sitikolin | 15 mg', '# 10 ml başına', 'Ginkgo ekstresi | 750 mg', 'Kore ginsengi ekstresi | 40 mg', 'Sitikolin | 30 mg'],
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'MultiGummy Мультивитаминные жевательные мармеладки — Витамин C, E, A, B12',
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'Женский комплекс — Фолиевая кислота, Цинк, Q10, Женьшень',
    ...
    specs: {
      ...
      tr: [
        '| **Aktif Bileşen** | **Miktar (2 Kapsül)** | **% günlük ihtiyaç** |',
        '| --- | ---: | ---: |',
  ...
  },
  {
    ...
    seoTitle: {
      ru: 'Железо бисглицинат + Витамин C — для гемоглобина и крови',
    ...
    specs: {
      ...
      tr: [
        '| **Aktif Bileşen** | **Miktar (1 Kapsül)** | **% günlük ihtiyaç** |',
        '| --- | ---: | ---: |',
