  ...
  return (
    <>
      <SEOHead
        ...
        keywords="Daruzen, о бренде, дарузен, турецкие витамины, витамины из Турции, витамины Турция, БАД, БАДы из Турции, пищевые добавки, качество, натуральные добавки, иммунитет, турецкие добавки, турецкий магний комплекс, турецкие витамины официальный дистрибьютор, витамины из турции с доставкой недорого, купить сертифицированные БАДы из стамбула, турецкие пищевые добавки халяль, интернет магазин витаминов напрямую из турции, турецкая омега 3, витамин д3 из турции, турецкий морской коллаген, органические витамины из турции"
