  ...
  return (
    <>
      <SEOHead
        ...
        keywords="Daruzen каталог, витамины, турецкие витамины, витамины из Турции, добавки, БАД, БАДы из Турции, дарузен, омега 3, магний, мультивитамины, минералы, натуральные добавки, турецкие добавки, витамины купить"
